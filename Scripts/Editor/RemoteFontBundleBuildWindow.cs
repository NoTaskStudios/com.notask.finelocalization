...
namespace FineLocalization.EditorTools
{
    ...
    public class RemoteFontBundleBuildWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/Fine Localization/Advanced/WebGL Remote Fonts/Open Bundle Builder Window", false, 60)]
        ...
        private void DrawBottomActions()
        {
            ...
            if (GUILayout.Button("▶ Build Bundles", GUILayout.Height(28)))
            {
                EditorUtility.SetDirty(_config);
                AssetDatabase.SaveAssetIfDirty(_config);
